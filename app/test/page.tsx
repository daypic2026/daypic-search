...
function HeroMiniPreview() {
  return (
    <div className="relative h-[104px] w-[128px] sm:h-[120px] sm:w-[150px]">
      <div className="absolute right-0 top-0 h-[92px] w-[76px] rounded-[20px] bg-white p-3 shadow-lg shadow-slate-200/80 ring-1 ring-[#ece8f0]">
        <div className="mb-2 h-1.5 w-10 rounded-full bg-[#c46b8d]" />
        <div className="mb-1.5 h-1.5 w-full rounded-full bg-[#e8e5ec]" />
        <div className="mb-1.5 h-1.5 w-4/5 rounded-full bg-[#e8e5ec]" />
        <div className="mb-3 h-1.5 w-3/5 rounded-full bg-[#e8e5ec]" />
        <div className="rounded-[12px] bg-[#f8f6fb] px-2 py-1">
          <p className="text-[9px] font-black text-[#6d6876]">견적서</p>
        </div>
      </div>

      <div className="absolute bottom-0 left-0 h-[100px] w-[88px] rounded-[22px] bg-white p-3 shadow-xl shadow-slate-300/60 ring-1 ring-[#e7c8d5]">
        <div className="mb-2 flex items-center justify-between">
          <p className="text-[9px] font-black text-[#c46b8d]">AI 분석</p>
          <div className="flex h-6 w-6 items-center justify-center rounded-full bg-[#b85c82] text-[10px] font-black text-white">
            92
          </div>
        </div>

        <p className="whitespace-nowrap text-[11px] font-black text-[#222237]">
          A 업체 추천
        </p>

        <div className="mt-2 space-y-1.5">
          <div className="h-1.5 w-full rounded-full bg-[#e8e5ec]" />
          <div className="h-1.5 w-4/5 rounded-full bg-[#e8e5ec]" />
        </div>

        <p className="relative -top-2 whitespace-nowrap text-[9px] font-bold text-[#c46b8d]">
          확인 필요 3건
        </p>
      </div>

      <div className="absolute left-[68px] top-[58px] flex h-7 w-7 items-center justify-center rounded-full bg-[#c46b8d] text-xs font-black text-white shadow-md shadow-[#c46b8d]/20">
        →
      </div>
    </div>
  );
  ...
  return (
    <main className="min-h-screen bg-[#fdfcff] text-[#222237]">
      <div className="mx-auto w-full max-w-5xl px-5 pb-40 pt-5 sm:px-8 lg:px-10">
        <section className="relative overflow-hidden rounded-[30px] bg-white px-6 py-7 shadow-sm ring-1 ring-[#ece8f0] sm:px-10 sm:py-10">
          ...
          <div className="relative z-10">
            ...
            <div className="flex items-start justify-between gap-8">
              ...
              <div className="mt-6 flex justify-end sm:mt-0 sm:shrink-0 sm:pt-8">
                <HeroMiniPreview />
              </div>
            </div>

            <p className="mt-4 max-w-2xl text-[14px] leading-6 text-[#6d6876] sm:text-[16px] sm:leading-7">
              AI가 견적을 분석하고 어떤 선택이 더 적합한지 이유와 함께
              알려드려요.
            </p>
            ...
            <div className="mt-6 grid grid-cols-3 gap-2">
              {featureCards.map(([title, desc]) => (
                <div
                  key={title}
                  className="rounded-[18px] bg-[#f8f6fb] p-3 ring-1 ring-[#ece8f0]"
                >
                  <p className="whitespace-nowrap text-[13px] font-black tracking-[-0.03em]">
                    {title}
                  </p>
                  <p className="mt-1 whitespace-nowrap text-[10px] leading-4 text-[#6d6876]">
                    {desc}
                  </p>
                </div>
              ))}
        ...
        <section className="mt-5 rounded-[26px] bg-[#222237] p-5 text-white shadow-sm sm:p-6">
          <p className="text-xs font-black text-[#e5a9bf]">
            단순 가격 비교가 아니에요
          </p>

          <h2 className="mt-3 text-[21px] font-black leading-[1.35] tracking-[-0.05em] sm:text-3xl">
            왜 선택해야 하는지,
            <br />
            왜 조심해야 하는지 알려드려요.
          </h2>
          ...
          <div className="mt-5 space-y-3 text-sm font-bold">
            {[
              ...
              <div key={item} className="flex items-center gap-3">
                <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full border border-[#e5a9bf] text-[11px] text-[#e5a9bf]">
                  ✓
                </span>
                <p>{item}</p>
              </div>
        ...
        <section className="mt-5 rounded-[28px] bg-white p-5 shadow-sm ring-1 ring-[#ece8f0] sm:p-7">
          <h2 className="text-xl font-black text-[#c46b8d] tracking-[-0.04em] sm:text-2xl">
            이런 고민 해본 적 있나요?
          </h2>
          ...
          <div className="mt-5 space-y-3">
            {concerns.map((item) => (
              <div
                key={item}
                className="rounded-[18px] bg-[#f8f6fb] px-4 py-3 text-sm font-extrabold text-[#222237]"
              >
                {item}
              </div>
            ))}
            ...
            {steps.map(([num, title, desc]) => (
              ...
              >
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs leading-5 text-[#6d6876]">
                    {desc}
                  </p>
                </div>
              </div>
        ...
        <section className="mt-5 rounded-[30px] bg-white p-5 shadow-sm ring-1 ring-[#ece8f0] sm:p-7">
          ...
          <div className="mt-5 rounded-[24px] border border-[#ece8f0] bg-[#fdfcff] p-5">
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="text-sm font-black text-[#c46b8d]">AI 추천 1위</p>
                <p className="mt-2 text-2xl font-black">A 업체</p>
              </div>
            ...
            <div className="mt-5 space-y-3 text-sm font-bold text-[#222237]">
            ...
            <div className="mt-5 rounded-[18px] bg-white p-4 ring-1 ring-[#ece8f0]">
              <p className="text-sm font-black text-[#c46b8d]">확인 필요</p>
              <p className="mt-2 text-sm leading-6 text-[#6d6876]">
